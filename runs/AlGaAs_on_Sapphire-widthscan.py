""" Calculate the backward SBS gain spectra as a function of
    waveguide width, for AlGaAs waveguides surrounded in air.
...
prefix_str = 'Al21GaAsOS-widthscan-h320nm-'
...
nu_widths = 8
waveguide_widths = np.linspace(700,1200,nu_widths)
geo_objects_list = []
